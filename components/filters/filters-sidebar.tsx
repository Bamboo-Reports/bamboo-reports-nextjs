...
export function FiltersSidebar({
  ...
  return (
    <div className={cn(
      ...
      {/* Collapse/Expand Button - Material Design Style */}
      <Button
        variant="ghost"
        size="icon"
      ...
      >
        <span className="relative h-5 w-5 flex items-center justify-center">
          {isCollapsed ? (
            <Menu className="h-5 w-5 absolute transition-all duration-300 ease-in-out rotate-0 opacity-100" />
          ) : (
            <>
              <Menu className="h-5 w-5 absolute transition-all duration-300 ease-in-out rotate-180 opacity-0" />
              <ArrowLeft className="h-5 w-5 absolute transition-all duration-300 ease-in-out rotate-0 opacity-100" />
            </>
          )}
        </span>
      </Button>
