  ...
  const cityData = useMemo(() => {
    try {
      ...
      centers.forEach((center) => {
        ...
        const account = center["ACCOUNT GLOBAL LEGAL NAME"] || ""
        const employees = center["CENTER EMPLOYEES"] ? center["CENTER EMPLOYEES"] : 0
        const lat = center.LAT ? center.LAT : null
        const lng = center.LANG ? center.LANG : null
